...
class VideoTutorijalSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $vt->embed_video='<iframe width="560" height="315" src="https://www.youtube.com/embed/-FvyyE4Dgiw?si=-JJFjj_XwKWz6ocI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
        $vt->resurs_id=2;
        $vt->save();
        ...
        $vt->embed_video='<iframe width="560" height="315" src="https://www.youtube.com/embed/H1Yp5_Xe_Kc?si=B7r0aAfUbaMRXQuS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
        $vt->resurs_id=2;
        $vt->save();
        ...
        $vt->embed_video='<iframe width="560" height="315" src="https://www.youtube.com/embed/SixkfaO8DZA?si=s1c8yMFCmMdHxbOu" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
        $vt->resurs_id=2;
        $vt->save();
        ...
        $vt->embed_video='<iframe width="560" height="315" src="https://www.youtube.com/embed/hH6_Y6ABfEs?si=ZXgbkWWxmqpP0KKC" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
        $vt->resurs_id=2;
        $vt->save();
    }
}
