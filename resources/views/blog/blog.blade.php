...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-8 offset-md-2 mb-5">
            ...
            <p class="mt-3" style="font-size: 14px">Категорија: {{ $blog->blogCategory->naziv }}</p>
            ...
            <form action="{{ route('komentar.dodajSubmit', ['blog_id' => $blog->id]) }}" method="post" class="mb-3">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-3" style="height: 40px">
                        <button type="submit" class="btn btn-primary w-100 p-0" style="height: 40px">Објави
                            коментар</button>
                    </div>
                </div>
            </form>
            @else
            <p>Морате бити улоговани да бисте коментарисали <a style="margin-left: 30px;" class="btn btn-primary p-2"
                    href="{{route('login')}}">Улогујте се</a></p>
            @endif
                ...
                <div class="list-group-item">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <a href="{{route('komentar.unpublishKorisnik', $komentar->id)}}" class="btn btn-danger p-1"
                                style="font-size: 12px;">Обриши</a>
                            @endif
                        </div>
                    </div>
