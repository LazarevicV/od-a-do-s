                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 40px; height: 40px;" class="align-middle">
                                <a href="{{ route('videoTutorijal.izmeni', $vt->id) }}"
                            ...
                            @if ($vt->objavljen)
                            <td style="width: 40px; height: 40px;" class="align-middle">
                                <a href="{{ route('videoTutorijal.unpublish', $vt->id) }}"
                            ...
                            @else
                            <td style="width: 40px; height: 40px;" class="align-middle">
                                <a href="{{ route('videoTutorijal.publish', $vt->id) }}"
                            ...
                            @endif
                            <td style="width: 40px; height: 40px;" class="align-middle">
                                <a href="{{ route('videoTutorijal.obrisi', $vt->id) }}"
                                    class="btn btn-danger btn-sm py-1">
...
<style>
    @media (max-width: 768px) {
        .ukloni_kada_je_ekran_mali {
            /* Remove margin on large screens */
            margin-top: 0;
        }
    }
</style>
